...
import { Sparkles, Bot, Cpu, Zap, CheckCircle, ArrowRight } from "lucide-react";
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-12 md:py-16 space-y-16">
        <div className="text-center space-y-5 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5" /> Official IELTS Assessment
            Criteria
          </div>
          ...
          <p className="text-gray-400 text-base md:text-lg leading-relaxed">
            ...
            Select an AI engine below to get detailed band scores, sub-criterion
            analysis, and Band 8.0+ model rewrites.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 border-t border-[#222]">
          <div className="bg-[#141414] border border-[#222] p-5 rounded-xl space-y-2">
            ...
            <h4 className="font-bold text-white text-sm">
              Strict IELTS Descriptors
            </h4>
            <p className="text-xs text-gray-400">
              Scored across Task Achievement, Coherence, Lexical Resource, and
              Grammar.
            </p>
          </div>
          ...
          <div className="bg-[#141414] border border-[#222] p-5 rounded-xl space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Dark-mode split screen matching the official computer-delivered
              test environment.
            </p>
          </div>
          ...
          <div className="bg-[#141414] border border-[#222] p-5 rounded-xl space-y-2">
            <CheckCircle className="w-5 h-5 text-indigo-400" />
            <h4 className="font-bold text-white text-sm">
              Instant Band 8.0 Rewrites
            </h4>
            <p className="text-xs text-gray-400">
              Compare your essay directly against examiner-level rewritten
              responses.
            </p>
          </div>
        </div>
